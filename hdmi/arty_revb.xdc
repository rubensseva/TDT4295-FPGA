...
set_property -dict { PACKAGE_PIN N11    IOSTANDARD LVCMOS33 } [get_ports { clk100mhz }]; #IO_L12P_T1_MRCC_35 Sch=gclk[100]
create_clock -add -name sys_clk_pin -period 40.00 -waveform {0 5} [get_ports { clk100mhz }];

## Clock definitions
create_generated_clock -name clkout0 -source [get_nets u_pll/clkref_i] -multiply_by 2 -divide_by 1 [get_nets u_pll/clkout0_o]
create_generated_clock -name clkout1 -source [get_nets u_pll/clkref_i] -multiply_by 10 -divide_by 1 [get_nets u_pll/clkout1_o]
...
##Pmod Header JB
set_property -dict { PACKAGE_PIN A5   IOSTANDARD TMDS_33 } [get_ports { tmds_out_p[0] }]; #IO_L11P_T1_SRCC_15 Sch=jb_p[1]
set_property -dict { PACKAGE_PIN A4   IOSTANDARD TMDS_33 } [get_ports { tmds_out_n[0] }]; #IO_L11N_T1_SRCC_15 Sch=jb_n[1]
set_property -dict { PACKAGE_PIN B6   IOSTANDARD TMDS_33 } [get_ports { tmds_out_p[1] }]; #IO_L12P_T1_MRCC_15 Sch=jb_p[2]
set_property -dict { PACKAGE_PIN B5   IOSTANDARD TMDS_33 } [get_ports { tmds_out_n[1] }]; #IO_L12N_T1_MRCC_15 Sch=jb_n[2]
set_property -dict { PACKAGE_PIN B7   IOSTANDARD TMDS_33 } [get_ports { tmds_out_p[2] }]; #IO_L23P_T3_FOE_B_15 Sch=jb_p[3]
